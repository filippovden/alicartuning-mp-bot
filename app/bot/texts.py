...
MORE_MENU = (
    "Что умеет бот\n\n"
    "«Новый товар» — фото и одно сообщение, карточка на площадки.\n"
    "«Мои товары» — открыть, выложить, поправить.\n"
    "«На другую модель» — та же деталь на другую Ладу.\n\n"
    "Черновики — кнопка ниже.\n"
    "Отмена текущего шага — кнопка «Начать заново» или напиши: отмена"
)
